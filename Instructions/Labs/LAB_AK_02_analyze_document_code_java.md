...
You can complete this exercise in GitHub Codespaces or on a local machine.
...
If you're using a local machine, verify your toolchain by running the following commands in a terminal:
...
1. Enter a prompt in the Chat view that generates an explanation of the App.java file.
   ...
   ```plaintext
   /explain Explain the App.java file
   ```
